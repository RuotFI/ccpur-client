  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 201) {
        setTimeout(() => {
          navigate("/login-page");
          // alert(response.data.message); // Redirect after 4s
        }, 2000);
      }
    } catch (error) {
      if (error.response) {
      ...
      >
        ...
        <div>
          ...
          >
                  ...
                  <option className="text-gray-500 text-sm" value="BA">BA</option>
                  <option className="text-gray-500 text-sm" value="BSc">BSc</option>
