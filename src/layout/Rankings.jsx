...
const Rankings = () => {
  ...
  return (
    <div className="w-full h-full px-4 lg:px-12">
      ...
      {/* Slider Section */}
      <div className="w-full py-12 bg-white flex items-center rounded-xl justify-center relative">
        <Slider className="w-full lg:max-w-7xl" {...settings}>
          {/* Slide 1 */}
          <div className="flex flex-col items-start justify-center px-2">
            <div className=" md:w-[300px] flex flex-col gap-5 lg:w-[300px] lg:h-[260px] h-[300px] md:h-[200px] bg-slate-50 p-4 shadow-lg border rounded-lg text-start">
              <div className="flex items-center gap-3">
                <LuUniversity className="w-12 h-12" />
                <div className="w-52 bg-green-400 h-[3px]"></div>
              </div>
              <h3 className=" text-gray-800 text-sm md:text-sm lg:text-lg font-semibold mb-2">
                No.1 Best Emerging College
              </h3>
          ...
          <div className=" md:w-[300px] flex flex-col gap-5 lg:w-[300px] lg:h-[260px] h-[300px] md:h-[200px] bg-slate-50 p-4 border shadow-lg rounded-lg text-start">
              <div className="flex items-center gap-3">
                <LuSchool className="w-12 h-12" />
                <div className="w-52 bg-red-400 h-[3px]"></div>
              </div>
              <div>
              <h3 className=" text-gray-800 text-sm md:text-sm lg:text-lg font-semibold mb-2">
          ...
          <div className=" md:w-[300px] flex flex-col gap-5 lg:w-[300px] lg:h-[260px] h-[300px] md:h-[200px] bg-slate-50 p-4 border shadow-lg rounded-lg text-start">
              <div className="flex items-center gap-3">
                ...
                <div className="w-52 bg-blue-400 h-[3px]"></div>
              </div>
              <h3 className=" text-gray-800 text-sm md:text-sm lg:text-lg font-semibold mb-2">
